...
const CHORD_SEQUENCE_FLAT = ['C', 'Db', 'D', 'Eb', 'E', 'F', 'Gb', 'G', 'Ab', 'A', 'Bb', 'B'];
const NOTE_ALIASES = new Map([
  ['N.C.'], ['C'], ['C#', 'Db'], ['D'], ['D#', 'Eb'], ['E'], ['F'],
...
class Chord {
  ...
  aliases() {
    ...
    return rootAliases.flatMap((root) => bassAliases.map((bass) => new Chord(root, this.quality, bass)));
  }
}
