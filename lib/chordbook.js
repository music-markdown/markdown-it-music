...
addGuitarChord(parseChord("Cmaj7"), "m1 n2,3 n3,2");
...
addGuitarChord(parseChord("Fmaj7"), "m1 m2 n3,3 n4,2 n5,1");

addGuitarChord(parseChord("G"), "n1,3 n2,2 n5,3 n6,3");
addGuitarChord(parseChord("G7"), "n1,3 n2,2 n6,1");
addGuitarChord(parseChord("G7sus4"), "n1,3 n2,3 b5,6,1");
...
addGuitarChord(parseChord("B7"), "m1 n2,2 n3,1 n4,2 n6,2");
